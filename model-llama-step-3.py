...
checkpoint_path = Path("model_checkpoint_learned/model_checkpoint.pth")
...
def create_datasets():
    ...
    full_train = pd.read_csv("datasets/datasett.csv")
    val_df = full_train.sample(frac=0.1, random_state=42)
...
class Trainer:
    ...
    def save_checkpoint(self):
        ...
        }, save_dir / "model_checkpoint_multi_class.pth")
    
        print("Checkpoint saved at model_checkpoint_learned/model_checkpoint.pth!")
